        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
              <div>
                <h3 style={{ fontSize: '20px', fontWeight: 800, color: 'var(--text-primary, #fff)', margin: 0 }}>💬 Support / Feedback</h3>
                <p style={{ fontSize: '13px', color: 'var(--text-secondary, #888)', marginTop: '4px' }}>Help us improve by reporting issues or sending feedback.</p>
              </div>
              <button
                onClick={handleClose}
                style={{
